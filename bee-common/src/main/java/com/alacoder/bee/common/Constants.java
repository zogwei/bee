...
public class Constants {
    ...
    public static final String  BEE_PROPERTIES_KEY               = "bee.properties.file";

    public static final String  DEFAULT_BEE_PROPERTIES           = "bee.properties";
    ...
    public static final String  DEFAULT_DIRECTORY                  = "bee";

    public static final String  DEFAULT_LOADBALANCE                = "random";

    public static final String  DEFAULT_PROTOCOL                   = "bee";
    ...
    public static final String  DEFAULT_REMOTING_CODEC             = "bee";
    ...
    public static final String  DEFAULT_REGISTRY                   = "bee";
    ...
    public static final String  DEFAULT_PROMPT                     = "bee>";
    ...
    public static final String  BEE_VERSION_KEY                  = "bee";
    ...
    @Deprecated
    public static final String  SHUTDOWN_WAIT_SECONDS_KEY          = "bee.service.shutdown.wait.seconds";

    public static final String  SHUTDOWN_WAIT_KEY                  = "bee.service.shutdown.wait";
    ...
    public static final String  STUB_EVENT_KEY                     = "bee.stub.event";

    public static final boolean DEFAULT_STUB_EVENT                 = false;

    public static final String  STUB_EVENT_METHODS_KEY             = "bee.stub.event.methods";
